#tag Class
Class OBJCSelectorManual
	#tag Method, Flags = &h0
		Sub Constructor(libName as string, methodType as string, returnType as string, selSubparts() as string, selSubpartTypes() as string, selParamNames() as String, isaConstructor as Boolean)
		  ...
		  self.isConstructor = isaConstructor
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function getMethod() As RBMethod
		  if isConstructor and InStr(selectorSubparts(0),"init")<>0 then
